        ...
        <section className="loginPage">
            <div className="loginSection">
               <div className="inside">
                <div className="loginTitle mywhite">
                    <h3><span className="myorange">Create</span> Account</h3>
                </div>
               <div className="formSection position-relative">
               <form action="" onSubmit={signUp}>
                   ...
                   {checkError && <Typography variant='body1'>{errorMsg}</Typography>}
                    ...
                    <div className="submitButton mybtn my-3">
